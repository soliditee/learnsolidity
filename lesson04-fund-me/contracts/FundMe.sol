...
contract FundMe {
    ...
    // immutable = variable can only be assigned during construction time, and only assigned once even during construction
    //   the contract creation code generated by the compiler will modify the contract's runtime code before it is returned 
    ...
    function fund() public payable {
        ...
        require(msg.value.getConversionRate() > MINIMUM_USD, "Please send more than 50 USD worth of Ether");
